...
{
	static readonly string version = "1.0.3f";// ALWAYS UDPATE
	static readonly int importantChanges = 0;// UPDATE ON IMPORTANT CHANGES
	static string menuTitle = "Main Menu";

	// LAYOUT STYLES //
    readonly int sectionSpace = 20;
    readonly int itemHeaderSpace = 10;
    readonly int paragraphSpace = 5;
	GUIStyle sectionHeaderStyle = new GUIStyle();
	GUIStyle itemHeaderStyle = new GUIStyle();
	GUIStyle paragraphStyle = new GUIStyle();

    readonly GUILayoutOption[] buttonSize = { GUILayout.Width( 200 ), GUILayout.Height( 35 ) };
    readonly GUILayoutOption[] docSize = { GUILayout.Width( 300 ), GUILayout.Height( 330 ) };
	GUISkin style;
	...
	static readonly PageInformation mainMenu = new PageInformation { pageName = "Main Menu" };
	static readonly PageInformation howTo = new PageInformation { pageName = "How To" };
	static readonly PageInformation overview = new PageInformation { pageName = "Overview" };
	static readonly PageInformation documentation = new PageInformation { pageName = "Documentation" };
	static readonly PageInformation otherProducts = new PageInformation { pageName = "Other Products" };
	static readonly PageInformation feedback = new PageInformation { pageName = "Feedback" };
	static readonly PageInformation changeLog = new PageInformation { pageName = "Change Log" };
	static readonly PageInformation versionChanges = new PageInformation { pageName = "Version Changes" };
	static readonly PageInformation thankYou = new PageInformation { pageName = "Thank You" };
	static readonly PageInformation settings = new PageInformation { pageName = "Window Settings" };
	static readonly List<PageInformation> pageHistory = new List<PageInformation>();
    ...
    readonly DocumentationInfo p_UpdateBar = new DocumentationInfo
    {
    ...
    readonly DocumentationInfo p_UpdateColor = new DocumentationInfo
    {
    ...
    readonly DocumentationInfo p_UpdateTextColor = new DocumentationInfo
    {
	...
	void HowTo ()
	{
		...
		EditorGUILayout.LabelField( "How To CreateDamage", sectionHeaderStyle );
